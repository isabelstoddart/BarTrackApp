//
//  StrictnessViewController.swift
//  BarTrack-tableView
//
...
class StrictnessViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        ref = Database.database().reference().child("venues").child((venue?.id!)!).child("strictnesss")
    }
    ...
    @IBAction func saveStrictness(_ sender: Any) {
