//
//  CrowdednessViewController.swift
//  BarTrack-tableView
//
...
class CrowdednessViewController: UIViewController {
    ...
    @IBAction func valueLabel(_ sender: UIStepper) {
    ...
    override func viewDidLoad() {
        ...
        ref = Database.database().reference().child("venues").child((venue?.id!)!).child("crowdednesss")
    }
    ...
    @IBAction func saveCrowdedness(_ sender: Any) {
